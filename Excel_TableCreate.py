...
class WindowController:
    ...
    def create_label3(self, justify_pos, text, xpos, ypos, width, height):
        font = f.Font(family="Lucida Console", weight="bold", size=12, slant="italic")
        self.label3 = tk.Label(self.master, justify=justify_pos, text=text, bg="white", fg="green")
        self.label3["font"] = font
        self.label3.place(x=xpos, y=ypos, width=width, height=height)
...
class MainApp:
    ...
    def create_sub1(self):
        self.sub_win1 = Toplevel(self.root)
        self.sub1_control = WindowController(self.sub_win1, "check_table", self.bg_white, "250x200")
    ...
    def create_sub2(self):
        print('create sub2')
        self.sub_win2 = Toplevel(self.root)
        self.sub2_control = WindowController(self.sub_win2, "value_table", self.bg_white, "250x200")
    ...
    def sub1_create_table(self):
        ...
        self.sub1_control.create_label3("center", "Excel書き込み完了", 25, 150, 200, 30)
    ...
    def sub2_create_table(self):
        ...
        self.wb.save(file_path)
        self.sub2_control.create_label3("center", "Excel書き込み完了", 25, 150, 200, 30)
